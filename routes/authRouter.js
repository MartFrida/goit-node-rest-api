...
import { signupSchema, signinSchema, verifyEmailSchema } from '../schemas/usersSchemas.js';
...
authRouter.post('/users/verify', validateBody(verifyEmailSchema), authController.resendVerifyEmail)
